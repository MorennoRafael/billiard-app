...
export default function FormTableVip({ isCloseVip, role }) {
        ...
        <div className="flex flex-col gap-1 py-2 px-3 w-full border border-double-light rounded-md">
            <div className="flex flex-col gap-1">
                <div className="flex items-center justify-between">
                    ...
                    <IoClose onClick={isCloseVip} size={24} className="text-[#BA181B] cursor-pointer" />
                </div>
...
FormTableVip.propTypes = {
    isCloseVip: PropTypes.func.isRequired,

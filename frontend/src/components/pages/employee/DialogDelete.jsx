...
export default function DialogDelete({ selectedEmployee, refreshData }) {
    ...
    const handleSubmitDelete = async () => {
        try {
            ...
            await axios.delete(`http://localhost:4000/employee/${selectedEmployee}`);
            toast.success("Delete employee successfull");
            refreshData();
        } catch (error) {
            console.error(error);
            toast.error("Delete employee not successfull")
        }
    };
        ...
        <>
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle className="font-bold text-black-primary text-2xl">Delete Employee</DialogTitle>
